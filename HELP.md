...
* The following dependencies are not known to work with Spring Native: 'Rest Repositories, Spring Web Services, Spring
  for RabbitMQ'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 nivelMercurio:0.0.1-SNAPSHOT
```
